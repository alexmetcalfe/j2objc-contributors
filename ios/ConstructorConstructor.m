...
//  source: jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/ConstructorConstructor.java
//


#line 1 "jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/ConstructorConstructor.java"
...
/**
 @brief Constructors for common interface types like Map and List and their subytpes.
 */
...
#line 57
  id<ComGoogleGsonInstanceCreator>
#line 58
  typeCreator = (id<ComGoogleGsonInstanceCreator>) check_protocol_cast([((id<JavaUtilMap>) nil_chk(instanceCreators_)) getWithId:type], @protocol(ComGoogleGsonInstanceCreator));
  if (typeCreator != nil) {
...
#line 69
  rawTypeCreator =
#line 70
  (id<ComGoogleGsonInstanceCreator>) check_protocol_cast([instanceCreators_ getWithId:rawType], @protocol(ComGoogleGsonInstanceCreator));
...
#line 181
    if ([JavaLangReflectParameterizedType_class_() isInstance:type] && !([NSString_class_() isAssignableFrom:
#line 182
    [((ComGoogleGsonReflectTypeToken *) nil_chk(ComGoogleGsonReflectTypeToken_getWithJavaLangReflectType_(IOSObjectArray_Get(nil_chk([((id<JavaLangReflectParameterizedType>) nil_chk(((id<JavaLangReflectParameterizedType>) check_protocol_cast(type, @protocol(JavaLangReflectParameterizedType))))) getActualTypeArguments]), 0)))) getRawType]])) {
...
#line 111
    @throw new_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_(JreStrcat("$@$", @"Failed to invoke ", val$constructor_, @" with no args"),
#line 112
...
#line 209
  JavaLangException *e) {
    @throw new_JavaLangRuntimeException_initWithNSString_withJavaLangThrowable_((JreStrcat("$@$", @"Unable to invoke no-args constructor for ", val$type_, @". Register an InstanceCreator with Gson for this type may fix this problem.")),
#line 211
    e);
  }
}
