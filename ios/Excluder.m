...
//  source: jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/Excluder.java
//


#line 1 "jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/Excluder.java"
...
#line 98
  ...
  if (deserialization) {
    ((ComGoogleGsonInternalExcluder *) nil_chk(result))->deserializationStrategies_ = new_JavaUtilArrayList_initWithJavaUtilCollection_(
#line 105
...
#line 155
  !ComGoogleGsonInternalExcluder_isValidVersionWithComGoogleGsonAnnotationsSince_withComGoogleGsonAnnotationsUntil_(self, [field getAnnotationWithIOSClass:ComGoogleGsonAnnotationsSince_class_()], [field getAnnotationWithIOSClass:ComGoogleGsonAnnotationsUntil_class_()])) {
    return YES;
  }
...
- (jboolean)excludeClassWithIOSClass:(IOSClass *)clazz
  ...
  if (version__ != ComGoogleGsonInternalExcluder_IGNORE_VERSIONS &&
#line 193
  !ComGoogleGsonInternalExcluder_isValidVersionWithComGoogleGsonAnnotationsSince_withComGoogleGsonAnnotationsUntil_(self, [((IOSClass *) nil_chk(clazz)) getAnnotationWithIOSClass:ComGoogleGsonAnnotationsSince_class_()], [clazz getAnnotationWithIOSClass:ComGoogleGsonAnnotationsUntil_class_()])) {
    return YES;
  }
...
#line 143
  d :
#line 144
  (self->delegate__ = [((ComGoogleGsonGson *) nil_chk(self->val$gson_)) getDelegateAdapterWithComGoogleGsonTypeAdapterFactory:self->this$0_ withComGoogleGsonReflectTypeToken:self->val$type_]);
}
