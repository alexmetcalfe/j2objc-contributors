...
#line 1 "jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/bind/JsonTreeReader.java"
...
#line 105
  if ([o isKindOfClass:[ComGoogleGsonJsonObject class]]) {
    return ComGoogleGsonStreamJsonTokenEnum_get_BEGIN_OBJECT();
  }
  else
#line 107
  if ([o isKindOfClass:[ComGoogleGsonJsonArray class]]) {
    return ComGoogleGsonStreamJsonTokenEnum_get_BEGIN_ARRAY();
  }
  else
#line 109
  if ([o isKindOfClass:[ComGoogleGsonJsonPrimitive class]]) {
...
#line 120
  if ([o isKindOfClass:[ComGoogleGsonJsonNull class]]) {
    return ComGoogleGsonStreamJsonTokenEnum_get_NULL();
  }
  else
#line 122
  if (o == ComGoogleGsonInternalBindJsonTreeReader_SENTINEL_CLOSED_) {
