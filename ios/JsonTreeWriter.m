...
#line 1 "jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/bind/JsonTreeWriter.java"
...
@interface ComGoogleGsonInternalBindJsonTreeWriter () {
 @public
  ...
  /**
   @brief The name for the next JSON object value.
   If non-null, the top of the stack is a JsonObject.
   */
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindJsonTreeWriter class]) {
    ...
    ComGoogleGsonInternalBindJsonTreeWriter_SENTINEL_CLOSED_ = new_ComGoogleGsonJsonPrimitive_initWithNSString_(
#line 46
    @"closed");
...
#line 82
  if ([((id<JavaUtilList>) nil_chk(self->stack_JsonTreeWriter_)) isEmpty]) {
    self->product_ = value;
  }
  else {
