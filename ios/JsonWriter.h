...
/**
 ...
 For best performance, ensure Writer is buffered; wrapping in java.io.BufferedWriter BufferedWriter if necessary.
 */
...
/**
 @brief Flushes and closes this writer and the underlying Writer .
...
/**
 @brief Ensures all buffered data is written to the underlying Writer and flushes that writer.
 */
- (void)flush;
...
/**
 @brief Returns true if this writer writes JSON that's safe for inclusion in HTML and XML documents.
 */
- (jboolean)isHtmlSafe;
...
/**
 @brief Configure this writer to emit JSON that's safe for direct inclusion in HTML and XML documents.
 This escapes the HTML characters <code><</code> , <code>></code> , <code>&</code> and <code>=</code> before writing them to the stream. Without this setting, your XML/HTML encoder should replace these characters with the corresponding escape sequences.
 */
- (void)setHtmlSafeWithBoolean:(jboolean)htmlSafe;

/**
 @brief Sets the indentation string to be repeated for each level of indentation in the encoded document.
 If <code>indent.isEmpty()</code> the encoded document will be compact. Otherwise the encoded document will be more human-readable.
 @param indent a string containing only whitespace.
 */
- (void)setIndentWithNSString:(NSString *)indent;

/**
 @brief Configure this writer to relax its syntax rules.
 By default, this writer only emits well-formed JSON as specified by <a href="http://www.ietf.org/rfc/rfc4627.txt">RFC 4627</a>. Setting the writer to lenient permits the following: <ul> <li>Top-level values of any type. With strict writing, the top-level value must be an object or an array. <li>Numbers may be Double#isNaN() NaNs or Double#isInfinite() infinities . </ul>
 */
...
/**
 @brief Encodes <code>value</code> .
 @param value a finite value. May not be Double#isNaN() NaNs or Double#isInfinite() infinities .
 @return this writer.
 */
