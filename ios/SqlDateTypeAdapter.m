...
#line 1 "jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/bind/SqlDateTypeAdapter.java"
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == JavaSqlDate_class_() ?
#line 43
  (ComGoogleGsonTypeAdapter *) check_class_cast(new_ComGoogleGsonInternalBindSqlDateTypeAdapter_init(), [ComGoogleGsonTypeAdapter class]) : nil;
}
