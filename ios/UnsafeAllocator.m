...
//  source: jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/UnsafeAllocator.java
//


#line 1 "jar:file:libs/gson-2.3.1-sources.jar!com/google/gson/internal/UnsafeAllocator.java"
...
#line 59
  @try {
    JavaLangReflectMethod *getConstructorId = [JavaIoObjectStreamClass_class_() getDeclaredMethod:
#line 61
    @"getConstructorId" parameterTypes:[IOSObjectArray newArrayWithObjects:(id[]){ IOSClass_class_() } count:1 type:IOSClass_class_()]];
    ...
    JavaLangReflectMethod *newInstance = [JavaIoObjectStreamClass_class_() getDeclaredMethod:
#line 65
    @"newInstance" parameterTypes:[IOSObjectArray newArrayWithObjects:(id[]){ IOSClass_class_(), [IOSClass intClass] } count:2 type:IOSClass_class_()]];
...
#line 82
  @try {
    JavaLangReflectMethod *newInstance = [JavaIoObjectInputStream_class_() getDeclaredMethod:
#line 84
    @"newInstance" parameterTypes:[IOSObjectArray newArrayWithObjects:(id[]){ IOSClass_class_(), IOSClass_class_() } count:2 type:IOSClass_class_()]];
    [((JavaLangReflectMethod *) nil_chk(newInstance)) setAccessibleWithBoolean:YES];
